...
<form action="insertinto.php" method="post">
  ...
  <div class="mb-3">
    <label  style="color: white;" for="project_name" class="form-label">Project Name</label>
    <input type="text"   class="form-control" name="project_name" id="project_name" aria-describedby="emailHelp">
  </div>

  <div class="mb-3">
    <label  style="color: white;" for="project_descb" class="form-label">Project Description</label>
    <input type="text" class="form-control" name="project_descb" id="project_descb">
  </div>
