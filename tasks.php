    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
                  <h2>Tasks</h2>
                  <br>
          <h3 style="color: white;">Track Your Tasks and Add a new one!</h3>
          <br>
             <h3 style="color: white;"> You can simple create a new task by clicking "Create Now!"</h3>
             <br>
             <div class="main-button-red">
                  <a href="create.task.php">Create Now!</a></div>
              </div>
...
$records = mysqli_query($conn,"select * from tasks where project_id = '$project_id'"); 
                  ...
                  <div class="meeting-item">
                    ...
                    <div class="down-content">
                      <div class="date">
                       ...
                       <p><?php echo $data['task_id'] ?></p>
                      <a href="meeting-details.html"><h4><?php echo $data['task_name'] ?></h4></a>
                      <p><?php echo $data['task_short_descb'] ?></p>
                        <br>
                 <div class="main-button-red">
                  <div ><a  style="background-color: #2ca170" href="task.detail.php?task_id=<?php echo $data['task_id']; ?>">Go to the Task</a></div>
              </div>
              <br>
                    </div>
                  </div>
